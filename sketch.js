...
function draw() {
  ...
  if(gameState === "play"){
    ...
    textSize(20);
    fill("black")
    text("Press spacebar to jump and avoid the obstacles and press right arrow key to move! If you want to play again press control + r" ,-200 , 200);
   ...
   textSize(25);
   fill("black");
   text("Distance: "+distance +" Km" , camera.position.x-700 , 50);  
